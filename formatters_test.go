...
func TestEscapedString(t *testing.T) {
	stru := struct {
		...
		I     int
		DNull *time.Time
	}{Foo: "foo", B: true, I: -1} //nolint:goconst
	...
	structVal := struct {
		...
		"str", 1, date, &date, nil, time.Duration(time.Minute * 5), //nolint:goconst
	} //nolint:goconst
	...
	tcases := []struct {
		...
		{"9007199254740990", "9007199254740990", `9007199254740990`},
		{"sint64", "9007199254740991", `_9007199254740991`},
		{"_int64", "_9007199254740991", `_9007199254740991`},
		{"bint64", "900719925474099123456", `900719925474099123456`},
		{"s2", "9007199_547409911", `9007199_547409911`},
		{"10000000000000000", "10000000000000000", `10000000000000000`},
		{"int", 1, "1"},
		{"bytes", []byte(`bytes`), `"Ynl0ZXM="`},
		{"uint", uint(11234123412), "11234123412"},
		{"int64", int64(11234123412), "11234123412"},
		{"xint64", int64(-9007199254740991), "_-9007199254740991"},
		{"uint64", uint64(11234123412), "11234123412"},
		{"xuint64", uint64(9007199254740991), "_9007199254740991"},
		...
		{"go errors", goerrors.New("go errors"), `"go errors"`},
